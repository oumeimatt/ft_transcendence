...
let DifficultService = class DifficultService {
    constructor(pongGameService, usersService) {
        ...
        this.emptyPlayground = new utils_1.PlayGround(0, 0, 1000, 600, '#0A63A3ff', 9, true, '', '');
    }
    ...
    joinPlayersToGame(first, second, wss) {
        ...
        const playground = new utils_1.PlayGround(0, 0, 1000, 600, '#0A63A3ff', 9, true, first.data.user.username, second.data.user.username);
