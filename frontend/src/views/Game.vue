  ...
  <div>
    ...
    <div v-if="store.state.player.status == 'online'">
      ...
      <div class="grid grid-rows-2 content-center gap-y-2 text-center ">
        <div class="mt-4 cursor-pointer mx-auto bg-slate-300 w-4/12 h-12 pt-2 rounded text-xl font-bold hover:bg-slate-700 hover:ring-white ring-2  hover:text-gray-100"> 
          <router-link :to="{name: 'Play', params: { difficulty: 'default' } }">
            Default
          </router-link>
        </div>
        <div class="mt-4 cursor-pointer mx-auto bg-slate-400 w-4/12 pt-2 h-12 rounded text-xl font-bold hover:bg-slate-700 hover:ring-white ring-2  hover:text-gray-100"> 
