...
<nav class="border-gray-200 px-2 sm:px-4 py-2.5 rounded  bg-slate-800 ">
...
<!-- logo -->
    <a class="flex items-center"> 
      ...
      <router-link :to="{name:'Home'}">
        <span class="self-center text-xl font-semibold whitespace-nowrap text-gray-300"> <span class="logo">YDA PONG </span></span>
      </router-link>
    </a>
<!--  -->
<!-- search navbar -->
    <div class="flex md:order-1">
      ...
      <div class="hidden relative md:block w-80">
        ...
        <input type="text" onfocus="this.value=''" id="search-navbar" class="block p-2 pl-10 w-full text-gray-900 bg-slate-600 rounded-xl border border-gray-300 sm:text-sm focus:ring-blue-500 focus:border-blue-500 border-gray-600 placeholder-gray-400 text-gray-300  focus:ring-blue-500 focus:border-blue-500" placeholder="Search..." v-model="search">
...
<!-- home chat game user -->
    <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1 relative" id="mobile-menu-3">
      ...
      <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
        <li>
          <router-link :to="{name:'Home'}">
            <a class="block py-2 pr-4 pl-3 mt-1  border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:p-0 md:hover:text-white text-gray-300 hover:bg-gray-700 hover:text-white md:hover:bg-transparent border-gray-700" aria-current="page"> Home</a>
          </router-link>
        </li>
        <li>
          <router-link :to="{name :'Game'}">
            <a class="block py-2 pr-4 pl-3 mt-1  border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:p-0 md:hover:text-white text-gray-300 hover:bg-gray-700 hover:text-white md:hover:bg-transparent border-gray-700">Game</a>
          </router-link>
        </li>
        <li>
        ...
        <li>
            ...
            <div v-if="show" class=" z-10 bg-slate-600 rounded-md shadow-xl lg:absolute top-11 right-0 w-44 absolute">
              <router-link  to="/Profile" class="block px-4 py-2 text-sm text-indigo-100 hover:bg-slate-500 hover:text-indigo-100 border-b border-slate-700">
                Profile </router-link> 
              <button type="button" @click="toggleModal()" class="w-44 block px-4 py-2 text-sm text-indigo-100 hover:bg-slate-500 hover:text-indigo-100  border-b border-slate-700">Settings
              </button>
